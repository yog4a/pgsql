...
import { Client } from 'src/core/client/client.class.js';
import { autoRetry } from 'src/core/utils.js';

type Callback = { onData: (messages: string[]) => void };

/**
 * This extension creates a listener handler for the client.
 * It will handle the retry logic for the listeners and the shutdown logic.
 */
