...
__export(utils_exports, {
  ...
  base64ToBytea: () => base64ToBytea,
  bigIntToString: () => bigIntToString,
  bitToString: () => bitToString,
  booleanToString: () => booleanToString,
  boxToString: () => boxToString,
  byteaToBase64: () => byteaToBase64,
  byteaToHex: () => byteaToHex,
  byteaToString: () => byteaToString,
  cidrToString: () => cidrToString,
  circleToString: () => circleToString,
  convertPgValue: () => convertPgValue,
  dateRangeToString: () => dateRangeToString,
  dateToString: () => dateToString,
  decimalToString: () => decimalToString,
  hexToBytea: () => hexToBytea,
  inetToString: () => inetToString,
  int4RangeToString: () => int4RangeToString,
  intervalToString: () => intervalToString,
  jsonToString: () => jsonToString,
  jsonbToString: () => jsonbToString,
  macAddrToString: () => macAddrToString,
  oidToString: () => oidToString,
  pointToString: () => pointToString,
  stringToArray: () => stringToArray,
  stringToBigInt: () => stringToBigInt,
  stringToBit: () => stringToBit,
  stringToBoolean: () => stringToBoolean,
  stringToBox: () => stringToBox,
  stringToBytea: () => stringToBytea,
  stringToCIDR: () => stringToCIDR,
  stringToCircle: () => stringToCircle,
  stringToDate: () => stringToDate,
  stringToDateRange: () => stringToDateRange,
  stringToDecimal: () => stringToDecimal,
  stringToINET: () => stringToINET,
  stringToInt4Range: () => stringToInt4Range,
  stringToInterval: () => stringToInterval,
  stringToJSON: () => stringToJSON,
  stringToJSONB: () => stringToJSONB,
  stringToMacAddr: () => stringToMacAddr,
  stringToOID: () => stringToOID,
  stringToPoint: () => stringToPoint,
  stringToTSQuery: () => stringToTSQuery,
  stringToTSVector: () => stringToTSVector,
  stringToTime: () => stringToTime,
  stringToTimestamp: () => stringToTimestamp,
  stringToTimestamptz: () => stringToTimestamptz,
  stringToUUID: () => stringToUUID,
  stringToXML: () => stringToXML,
  timeToString: () => timeToString,
  timestampToString: () => timestampToString,
  timestamptzToString: () => timestamptzToString,
  tsqueryToString: () => tsqueryToString,
  tsvectorToString: () => tsvectorToString,
